        ...
        Column {
            ...
            Grid {
                ...
                Rectangle {
                    id: sessionTile
                    width: 180 * s; height: 70 * s; radius: 8 * s
                    color: sessionMouse.pressed ? "#7658C3" : (sessionMouse.containsMouse ? "#A597DC" : "#121212")
                    ...
                    Row {
                        ...
                        Column {
                            ...
                            Text {
                                ...
                                font.pixelSize: 12 * s
                                font.bold: true
                                color: sessionMouse.containsMouse ? "#202020" : "#A597DC"
                                Behavior on color { ColorAnimation { duration: 150 } }
                            }
                            Text {
                                ...
                                font.family: root.sansFont
                                font.pixelSize: 9 * s
                                color: sessionMouse.containsMouse ? "#121212" : "#9886DD"
                                Behavior on color { ColorAnimation { duration: 150 } }
                ...
                Column {
                    ...
                    Rectangle {
                        ...
                        TextInput {
                            ...
                            Text {
                                ...
                                font.bold: true
                                font.letterSpacing: 1.5 * s
                                color: root.errorMessage !== "" ? "#EA1821" : "#9582D4"
                    ...
                    Row {
                        ...
                        Rectangle {
                            ...
                            height: 38 * s
                            radius: 8 * s
                            color: userMouse.pressed ? "#7658C3" : (userMouse.containsMouse ? "#856DCC" : "#A597DC")
                        ...
                        Item {
                            ...
                            Rectangle {
                                ...
                                height: 38 * s
                                radius: 8 * s
                                color: loginMouse.pressed ? "#7658C3" : (loginMouse.containsMouse ? "#9886DD" : "#A597DC")
